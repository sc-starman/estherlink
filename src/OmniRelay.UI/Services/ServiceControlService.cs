...
{
    private const string ServiceName = "OmniRelay.Service";
    private const string ServiceExeName = "OmniRelay.Service.exe";
...
";
    ...
    {
        var scriptPath = Path.Combine(Path.GetTempPath(), $"OmniRelay-ui-{Guid.NewGuid():N}.ps1");
    ...
    {
        var env = Environment.GetEnvironmentVariable("OmniRelay_SERVICE_EXE_PATH");
        ...
        var candidates = new[]
        {
            ...
            Path.Combine(baseDir, "..", "..", ServiceExeName),
            Path.Combine(baseDir, "..", "..", "service", ServiceExeName),
            Path.Combine(baseDir, "..", "..", "..", "..", "OmniRelay.Service", "bin", "Debug", "net8.0-windows", ServiceExeName),
            Path.Combine(baseDir, "..", "..", "..", "..", "OmniRelay.Service", "bin", "Release", "net8.0-windows", ServiceExeName),
